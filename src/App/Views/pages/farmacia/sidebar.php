<div class="col-lg-3 col-md-5 sticky-col bs-component">
	<div id="region-sidebar" class="card sidebar-relevant">
		<h6 class="card-header"><?= \Lang\Dictionary::get('other_phamacies_that_may_interest_you') ?></h6>
			  ...
			  <div class="accordion-item">
			    <h6 class="accordion-header" id="relevant-sidebar-section-parishHeader">
			      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#relevant-sidebar-section-parishCollapse" aria-expanded="<?= $groupingShowed ? 'false' : 'true' ?>" aria-controls="relevant-sidebar-section-parishCollapse">
			        <div>
				        <?= \Lang\Dictionary::get('pharmacies_from') . ' ' . $farmacia['concelho']['title'] ?>
			        </div>					
			      </button>
			    </h6>
			    <div id="relevant-sidebar-section-parishCollapse" class="accordion-collapse collapse <?= $groupingShowed ? '' : 'show' ?>" aria-labelledby="relevant-sidebar-section-parishHeader">
			      ...
			      <div class="accordion-body">
			      	<div id="sidebar_municipality_pharmacies_list" data-pagination-page_limit="8" data-pagination-start_page="1" data-pagination-margin2edges="2" data-pagination-margin2current="1">
			        <?php foreach($sidebar['municipality_pharmacies']['items'] as $unit) : ?>
						<div class="col-12">
							<a href="<?= $unit['url'] ?>">
					...
					<div id="sidebar_municipality_pharmacies_pagination" class="view_more_wrap"></div>
			      </div>
...
<script type="text/javascript" defer>
	const municipalityPharmacies = new Pagination('municipalityPharmacies', $("#sidebar_municipality_pharmacies_list"), $("#sidebar_municipality_pharmacies_pagination"));
</script>
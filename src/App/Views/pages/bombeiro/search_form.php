<?php
	$searchFormURL = $site['baseURL'] .'/'. $pageLang .'/'. \Lang\Dictionary::get('urlparam_firefighters') .'/'. \Lang\Dictionary::get('urlparam_search');
?>
<form method="GET" action="<?= $searchFormURL ?>">
	<div class="row search-form">

		<?php 
		$formErrors = \Form::getFormErrors('firefighters_search');

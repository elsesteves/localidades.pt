<?php
	$searchFormURL = $site['baseURL'] .'/'. $pageLang .'/'. \Lang\Dictionary::get('urlparam_tourism_points') .'/'. \Lang\Dictionary::get('urlparam_search');
?>
<form method="GET" action="<?= $searchFormURL ?>">
	<div class="row search-form">

		<?php 
		$formErrors = \Form::getFormErrors('tourism_search');
		...
		<div class="col-4 mb-2 form-group">
			<label for="types-select"><?= \Lang\Dictionary::get('tourism_point_types') ?></label>
			<select class="form-control" id="types-select" name="id_tipo">
				<option value=""><?= \Lang\Dictionary::get('tourism_point_type_select') ?></option>

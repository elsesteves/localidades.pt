<?php if (exists($pharmacies['items'])) : ?>
	<div class="pb-4">		
		<div id="pharmacies_points_list" class="row gx-2 gy-2 points_list" data-pagination-page_limit="12"  data-pagination-start_page="1" data-pagination-margin2edges="2" data-pagination-margin2current="1">
			...
			<?php foreach($pharmacies['items'] as $pharmacy) : ?>
				<div class="col-md-6 col-lg-4 col-xxl-3">
					<a href="<?= $pharmacy['url'] ?>">
						<div class="point_card">
							...
							<div class="info">
								<div class="title"><?= $pharmacy['title'] ?></div>
								<div class="address"><?= $pharmacy['address'] ?></div>
								<?php if(exists($pharmacy['freguesia'])) : ?>
								<div class="freguesia"><?= $pharmacy['freguesia']['title'] ?></div>
								<?php endif; ?>
							</div>
						</div>
					</a>

...
$id_type = 1; //Alojamento
$id_categoria_freguesiasPT= '1'; //Alojamento em freguesias.pt https://www.freguesias.pt/portal/onde_comer_dormir.php?cod=011201&categoria=0&button=Listar
...
foreach($rows as $row) {
	...
	foreach($ids_freguesiaspt as $id_freguesiaspt) {
		...
		$re = '/<img src="imagens\/icon_hotel.gif" alt="Hotel" title="Hotel" width="16">(.*?)<\/table><\/td><\/tr><\/table><\/td>/ms';
